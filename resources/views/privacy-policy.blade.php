<x-layout>
    <x-card class="w-3/4 mx-auto">
        <div class="">
            ...
            <h2 class="text-lg font-bold">Interpretation</h2>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The
                following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h2 class="text-lg font-bold">Definitions</h2>
            <p>For the purposes of this Privacy Policy:</p>
            <ul class="list-disc ml-10" class="list-disc ml-10">
                <li>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Smart:Hire, Aastvej 10B.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Smart:Hire, accessible from <a href="smarthire.dk"
                            rel="external nofollow noopener" target="_blank">smarthire.dk</a></p>
                </li>
                <li>
            ...
            <h2 class="text-lg font-bold">Types of Data Collected</h2>
            ...
            <p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy
                ...
                <br>
            <h2 class="text-lg font-bold">Use of Your Personal Data</h2>
            ...
            <br>
            <h2 class="text-lg font-bold">Retention of Your Personal Data</h2>
            ...
            <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a
                ...
                <br>
            <h2 class="text-lg font-bold">Transfer of Your Personal Data</h2>
            ...
            <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
                ...
                information.</p>
                <br>
            <h2 class="text-lg font-bold">Disclosure of Your Personal Data</h2>
            ...
            <ul class="list-disc ml-10">
                <li>By email: admin@smarthire.dk</li>
            </ul>
        </div>    
    </x-card>
</x-layout>